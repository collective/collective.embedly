...
def get_oembed(url):
    ...
    params.update([param.split('=', 1)
        for param in params['url'].split('&amp;')[1:]
        if param.count("=")>0 and param.split('=', 1)[0] in add_params])
