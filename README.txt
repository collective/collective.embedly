...
* Go to your site HTML Filtering panel (/@@filter-controlpanel) and add tags that are used for embedding content from that external service into the list of 'Custom Tags' and remove them from the lists of 'Nasty Tags' and 'Stripped Tags'. These are usually such tags as 'embed', 'object', 'iframe' and others.
